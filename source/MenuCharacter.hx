...
class MenuCharacter extends FlxSprite
{
	...
	public function new(x:Int, y:Int, scale:Float, flipped:Bool)
	{
		...
		frames = Paths.getSparrowAtlas('menucharacter/campaign_menu_UI_characters');
		var tex = Paths.getSparrowAtlas('menucharacter/dad');
		var tex = Paths.getSparrowAtlas('menucharacter/spooky');
		var tex = Paths.getSparrowAtlas('menucharacter/pico');
		var tex = Paths.getSparrowAtlas('menucharacter/mom');
		var tex = Paths.getSparrowAtlas('menucharacter/parents-christmas');
		var tex = Paths.getSparrowAtlas('menucharacter/senpai');
